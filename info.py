...
# PyroClient Setup 
API_ID = int(environ('24160099'))
API_HASH = environ('381515f2540b0bf817a68af8b352f5b7')
BOT_TOKEN = environ('8026870399:AAH5eVx9RBQuTVW_ucDQ2WffEOi1eYT774U')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://sivanesh:9488128178siva@cluster02.uyxp6bz.mongodb.net/?retryWrites=true&w=majority&appName=cluster02")
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://files.catbox.moe/41hnnp.jpg")
...
# url shortner
SHORT_URL = environ.get("linkshortify.com")
SHORT_API = environ.get("a92b887385ad479ce9d1e361907d757ae11ac0b3")

# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "300"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002853893090'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'getmediachatbot')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002732787759')).split()]
